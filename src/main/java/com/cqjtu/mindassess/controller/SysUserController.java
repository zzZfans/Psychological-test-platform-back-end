...
public class SysUserController {
     ...
     * 用户名密码登录方式
     */
    public static final Integer LOGIN_TYPE_USERNAME_PASSWORD = 0;
    /**
     * 电话号码 手机验证码登录方式
     */
    public static final Integer LOGIN_TYPE_PHONE_CODE = 1;
    /**
     * 电子邮箱 邮箱验证码登录方式
     */
    ...
    public ApiResponse<?> login(@Validated @RequestBody UserSmLoginDto dto ) {
        ...
        }else if ( type == LOGIN_TYPE_PHONE_CODE ) {
        ...
        }else if ( type == LOGIN_TYPE_EMAIL_CODE ) {
